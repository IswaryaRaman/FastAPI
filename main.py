...
import uvicorn 
import part3_query_param,part4_request_body,part5_queryparam_validation,part6_pathparam_validation,part7_body_multipleparam,part8_body_fields,part9_nested_models
app=FastAPI()
...
app.include_router(part9_nested_models.router7)
